...
func writeWindowManagerDesktopFile(pkgname, name, execCommand, custom string, force bool, o *vt.TextOutput) {
	...
	if exists(pkgname+".desktop") && !force {
		o.Err("no")
		o.Eprintf("%s.desktop already exists. Use -f as the first argument to overwrite it.\n", pkgname)
		os.Exit(1)
	}
...
func writeDesktopFile(pkgname, name, comment, execCommand, icon, path, categories, genericName, mimeTypes, custom string, useTerminal, startupNotify, force bool, o *vt.TextOutput) {
