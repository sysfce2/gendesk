...
func writeWindowManagerDesktopFile(pkgname, name, execCommand, custom, output string, force bool, o *vt.TextOutput) {
	...
	// Use the given output filename if specified, otherwise fall back to pkgname.desktop
	filename := output
	if filename == "" {
...
func writeDesktopFile(pkgname, name, comment, execCommand, icon, path, categories, genericName, mimeTypes, custom, output string, useTerminal, startupNotify, force bool, o *vt.TextOutput) {
...
func main() {
	...
	for _, pkgname := range pkgnames {
		...
		if *windowmanager {
			writeWindowManagerDesktopFile(pkgname, name, execCommand, custom, outputFilename, *force, o)
		} else {
			writeDesktopFile(pkgname, name, comment, execCommand, *icon, *path, categories, genericName, mimeTypes, custom, outputFilename, *terminal, *startupnotify, *force, o)
		}
